    ...
    .then(data =>{
        if(data.status == 'success'){
            ...
            if(story_slug && author == null){
                ...
                let text = document.getElementById('search-story');
                text.value = '';
                text.setAttribute('placeholder', 'Không có kết quả phù hợp...');
            }
        }
    })
    ...
    .then(data =>{
        if(data.status == 'success'){
            ...
            if(story_slug && author == null){
                ...
                let text = document.getElementById('search-story-mobile');
                text.value = '';
                text.setAttribute('placeholder', 'Không có kết quả phù hợp...');
            }
        }
    ...
    .then(data =>{
        if(data.status == 'success'){
            ...
            if(story_slug && author == null){
                ...
                let text = document.getElementById('search-story-tablet');
                text.value = '';
                text.setAttribute('placeholder', 'Không có kết quả phù hợp...');
            }
        }
